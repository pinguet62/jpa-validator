...
public class AutoGeneratedIdValidator extends AbstractValidator {

    public AutoGeneratedIdValidator(Class<?> entity, String tableName) {
    ...
    public Collection<Class<? extends Annotation>> getNotYetSupportedAnnotations() {
        return asList(TableGenerator.class, ManyToOne.class);
    }
