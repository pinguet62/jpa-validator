...
public class ManytooneTargetInvalidTest {
    ...
    @Test
    @Script({ "create table PERSON ( ID_PERSON character varying(99) /*not null*/ primary key );",
            "create table BAD ( ID_BAD character varying(99) /*not null*/ primary key );",
